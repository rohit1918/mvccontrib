...
{
	[TestFixture]
	public class When_Add_Route_For_Controller_In_A_Different_Path : RestfulRoutingFixture
	{
		protected override void SetUp()
		{
			_restfulRoutingBuilder.ForAnyController().FromPath("admin").AddControllerToRuleSet(typeof(AController)).Register();
