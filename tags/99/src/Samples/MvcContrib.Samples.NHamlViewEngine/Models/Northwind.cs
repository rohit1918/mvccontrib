...
namespace MvcContrib.Samples.NHamlViewEngine.Models
{
    ...
    partial void OnPictureChanged();
		...
		[Column(Name="Category ID", Storage="_CategoryID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
    ...
    partial void OnReportsToChanged();
		...
		[Column(Name="Employee ID", Storage="_EmployeeID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
    ...
    partial void OnDiscountChanged();
		...
		[Association(Name="Order Details_FK01", Storage="_Order", ThisKey="OrderID", OtherKey="OrderID", IsForeignKey=true, DeleteOnNull=true)]
		public Order Order
		{
			get
			{
    ...
    partial void OnDiscontinuedChanged();
		...
		[Column(Name="Product ID", Storage="_ProductID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ProductID
		{
			get
			{
		...
		[Association(Name="Order Details_FK00", Storage="_OrderDetails", ThisKey="ProductID", OtherKey="ProductID", DeleteRule="NO ACTION")]
		public EntitySet<OrderDetail> OrderDetails
		{
			get
			{
    ...
    partial void OnCompanyNameChanged();
		...
		[Column(Name="Shipper ID", Storage="_ShipperID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
    ...
    partial void OnFaxChanged();
		...
		[Column(Name="Supplier ID", Storage="_SupplierID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
